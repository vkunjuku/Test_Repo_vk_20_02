[![dlt_src_bronze DEV](https://github.com/orajson/dlt_bronze/actions/workflows/onpush_dlt_src_bronze.yml/badge.svg)](https://github.com/orajson/dlt_bronze/actions/workflows/onpush_dlt_src_bronze.yml)

# dlt-pipelines

This is a sample project for Databricks, generated via cookiecutter. Updated
...
```bash
conda create -n dlt_pipeline1 python=3.9
conda activate dlt_pipeline1
```
...
This command will create your personal repository under `/Repos/<username>/dlt_pipeline1`. 3. Use `git_source` in your job definition as described [here](https://dbx.readthedocs.io/en/latest/examples/notebook_remote.html)
...
- To trigger the release pipeline, get the current version from the `dlt_pipeline1/__init__.py` file and tag the current code version:
